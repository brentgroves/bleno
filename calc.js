/*
NEXT: I am reading chapter #2 from the E-book and attempting to implement the calc, and just copied this code into blenotest from bluetooth-blog-post. 
Read through the code and run node calc. Then use Adroid BLE terminal as directed.
Chapter #2
https://content.skyrise.tech/hubfs/E-books/Bluetooth-with-Raspberry-Pi-and-bleno-by-skyrise_tech.pdf
https://github.com/bt-skyrise/bluetooth-blog-post


A base Bluetooth UUID is 00000000-0000-1000-8000-00805F9B34FB .All services and
attributes using short 16 and 32 bit uuids are actually converted from 128 bit XXXXYYYY0000-1000-8000-00805F9B34FB format. When selecting a custom UUID, make sure it is not
in that range. Remember that you have no guarantee on the uniqueness of the UUID –
somebody else might be also using it.
*/
